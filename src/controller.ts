...
// The controller persists {active, index, isReplay} in sessionStorage (one key
// per field, no JSON) so the tour resumes on the next page at the right step.
